...
# this freeze captures the packages installed in the current environment, which is our virtual environment. So we can run our app in different environments and machines.
